...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint32_t Frequency = 400; //in Hertz
float DutyCycle_output = 30; //From 0 to 100
uint32_t ARR4 = 0; //Counter Period, Auto Reload Register, see Parameter Settings of timer 2.
