...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
float Duty = 0; //Duty cycle coefficient: 0->0%, 1->100%
uint32_t PWM_input_period = 0; //Period of the hole PWM function(ms)
uint32_t PWM_input_pulseON = 0; //Pulse width(ms), of the positive part, on.
uint32_t Frequency = 0;//Frequency of the PWM hole function (Hz)
/* USER CODE END 0 */
